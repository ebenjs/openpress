  ...
  <div class="d-flex align-items-center action-bar">
    <div class="actions-wrapper d-flex">
      ...
      <CustomPopover v-if="isPopoverActive">
        <p class="filter-title">Filter notes in this directory by</p>
        <div class="form-check">
          <input
            v-model="filterOptions.read"
        ...
        <div class="form-check">
          <input
            v-model="filterOptions.unread"
            class="form-check-input"
            type="checkbox"
            value="unread"
            id="unreadCheckbox"
          />
          <label class="form-check-label" for="unreadCheckbox"> Unread </label>
        </div>
      </CustomPopover>
    </div>
